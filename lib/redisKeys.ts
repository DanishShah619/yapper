...
export const RedisKeys = {
  ...
  // TTL: 24 hours (cleared when room closes)
  videoRoomLock: (roomId: string) =>
    `videoroom:lock:${roomId}`,
};
...
export const STALE_SHARD_THRESHOLD_MINUTES = 15;

// Maximum number of re-delivery attempts before giving up and alerting admin
export const MAX_REDELIVERY_ATTEMPTS = 3;
