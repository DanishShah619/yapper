...
## Corpus Check
- 93 files · ~42,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 238 nodes · 204 edges · 10 communities detected
...
Cohesion: 0.21
Nodes (11): register(), detectAndAlertStaleShards(), getRoomKeyHealth(), markShardAcknowledged(), markShardDecrypted(), markShardDelivered(), pushHealthUpdateToAdmins(), redeliverShard() (+3 more)
...
- **Why does `encryptMessage()` connect `Community 2` to `Community 0`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `decryptMessages()` connect `Community 0` to `Community 7`?**
